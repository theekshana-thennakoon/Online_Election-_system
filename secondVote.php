...
<section class="content text-center">
	<h2>Select your second vote</h2>
	<h1 class = "sinhala"> ඔබේ දෙවන ඡන්දය තෝරන්න </h1>
	<h2>உங்கள் இரண்டாவது வாக்கைத் தேர்ந்தெடுக்கவும்</h2>
</section>
<section class="content">
	...
	<div class="row">
		<?php
			...
			$sql = "SELECT * FROM candidates where pid = {$party_id} and id != {$first_vote_id}";
	...
	<center>
		<button type='submit' name = 'select_second_vote' class='btn btn-primary w-50 pt-3 pb-3 fs-4' style = 'background:#9C53A0' disabled>Record your second vote | ඔබේ දෙවන ඡන්දය සටහන් කරන්න <br> உங்கள் இரண்டாவது வாக்கை பதிவு செய்யுங்கள்</button>
		<a href="submit_vote">
